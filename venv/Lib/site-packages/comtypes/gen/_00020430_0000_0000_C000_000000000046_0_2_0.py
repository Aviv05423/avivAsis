...
IFontDisp = Font
__all__ = [ 'FONTITALIC', 'FONTSIZE', 'LoadPictureConstants',
           'IFontEventsDisp', 'OLE_YSIZE_PIXELS', 'OLE_XSIZE_PIXELS',
           'OLE_OPTEXCLUSIVE', 'OLE_XPOS_HIMETRIC', 'VgaColor',
           'OLE_YSIZE_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL', 'FONTBOLD',
           'OLE_HANDLE', 'OLE_COLOR', 'FONTSTRIKETHROUGH', 'Checked',
           'Monochrome', 'FONTUNDERSCORE', 'OLE_XPOS_PIXELS',
           'OLE_CANCELBOOL', 'IPictureDisp', 'OLE_YSIZE_CONTAINER',
           'OLE_YPOS_CONTAINER', 'OLE_YPOS_PIXELS', 'FontEvents',
           'IPicture', 'StdFont', 'StdPicture', 'Font', 'Color',
           'Picture', 'OLE_XSIZE_CONTAINER', 'Unchecked', 'IFontDisp',
           'OLE_XPOS_CONTAINER', 'OLE_TRISTATE', 'Default', 'Gray',
